...
var Item = function (_Component) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var quantity_milestones = this.props._milestones;
      var _temp = this.props.groupHeights[0]/quantity_milestones;
      var focus = this.props.focus;

      if(focus === 'day' || focus === 'week') {
        if (this.props.item.group === 'milestones') {
          height = 50;
        } 
      }
      ...
      if(focus === 'day' || focus === 'week') {
        if (this.props.item.group !== 'milestones') {
          ...
          if(quantity_milestones > 1) {
            //top = top - (25 * quantity_milestones) - (50 * (quantity_milestones - 1));
            //top = dimensions.top - (height * (quantity_milestones * 2)) - 25;
            top = top - (height * (quantity_milestones - 1)) - 25;
          } else {    
            top = top - 25;
          }
      ...
      if(focus === 'month') {
        if(this.props.item.ganttView) {

          if(quantity_milestones > 1) {
            top = dimensions.top - (height * (quantity_milestones - 1)) + 5;
          } 
