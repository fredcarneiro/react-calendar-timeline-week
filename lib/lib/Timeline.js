...
console.log(realUnit,this.props.intendedFocus);
      if ((realUnit === "day" ? "day" : "week") != this.props.intendedFocus){
    ...
    console.log("update",realUnit,(realUnit === "day" ? "day" : "week"),nextProps.intendedFocus);
      if ((realUnit === "day" ? "day" : "week") != nextProps.intendedFocus){
    ...
    value: function changeZoom(scale) {
      ...
      if ((oldMinUnit === "day" ? "day" : "week") != (newMinUnit === "day" ? "day" : "week")){
