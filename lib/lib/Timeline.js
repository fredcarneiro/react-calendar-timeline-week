...
var ReactCalendarTimeline = function (_Component) {
  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    var realUnit = (0, _utils.getMinUnit)(this.state.visibleTimeEnd - this.state.visibleTimeStart, this.state.width, this.props.timeSteps, this.props.minCellWidth);

      if (realUnit != this.props.intendedFocus){
        this.props.onUnitChange(realUnit,this.props.intendedFocus);
      }
    }}, {key: 'componentWillUpdate', value: function componentWillUpdate(nextProps,nextState) {
    var realUnit = (0, _utils.getMinUnit)(nextState.visibleTimeEnd - nextState.visibleTimeStart, nextState.width, nextProps.timeSteps, nextProps.minCellWidth);
   if (realUnit != nextProps.intendedFocus){

        this.props.onUnitChange(realUnit,nextProps.intendedFocus);
      }
  }}, {
    ...
    value: function changeZoom(scale) {
      ...
      var oldMinUnit = (0, _utils.getMinUnit)(oldZoom, this.state.width, this.props.timeSteps, this.props.minCellWidth);
      var newMinUnit = (0, _utils.getMinUnit)(newZoom, this.state.width, this.props.timeSteps, this.props.minCellWidth);
      if (oldMinUnit != newMinUnit){
        this.props.onUnitChange(newMinUnit,oldMinUnit);
      }
    ...
    value: function __dragItem__REACT_HOT_LOADER__(item, dragTime, newGroupOrder) {
      ...
      if(this.props.onDragItem) {
        this.props.onDragItem(item, dragTime, newGroupOrder);
      }
    }
  }, {
    key: '__dropItem__REACT_HOT_LOADER__',
    value: function __dropItem__REACT_HOT_LOADER__(item, dragTime, newGroupOrder) {
      this.setState({ draggingItem: null, isDragging: false, selectedItem: null, dragTime: null, dragGroupTitle: null });
    ...
    key: 'horizontalLines',
    value: function horizontalLines(canvasWidth, groupHeights, headerHeight, _focus) {
    ...
    value: function items(canvasTimeStart, zoom, canvasTimeEnd, canvasWidth, minUnit, dimensionItems, groupHeights, groupTops) {
      return _react2.default.createElement(_Items2.default, { canvasTimeStart: canvasTimeStart,
        ...
        focus: this.props.intendedFocus });
    }
  }, {
    key: 'infoLabel',
    ...
    value: function render() {
      var _props6 = this.props,
          ...
          minCellWidth = _props6.minCellWidth,
      ...
      var minUnit = (0, _utils.getMinUnit)(zoom, width, timeSteps, minCellWidth);
      var headerHeight = headerLabelGroupHeight + headerLabelHeight;
      ...
      var outerComponentStyleHeight = 0;
      var milestones = this.props.items.filter(function(item){
        return item.craft === 'milestones';
      });

      var newHeight = groupHeights.reduce(function(acc, val, index) { 
        if(index === 0) return acc + 50;
        return acc + val;
      }, 0);

      outerComponentStyleHeight = newHeight + 60;

      if(this.props.intendedFocus === 'month') {
        outerComponentStyleHeight = newHeight + 40;
      }

      var outerComponentStyle = {
        height: outerComponentStyleHeight + 'px'
      };    
      ...
      var _focus = this.props.intendedFocus;
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              this.horizontalLines(canvasWidth, groupHeights, headerHeight, _focus),
...
ReactCalendarTimeline.propTypes = {
  ...
  intendedFocus: _propTypes2.default.oneOf(['day', 'week']),
  ...
  onUnitChange: _propTypes2.default.func,
...
ReactCalendarTimeline.defaultProps = {
  ...
  onUnitChange: function onTimeChange(newUnit, oldUnit) {
