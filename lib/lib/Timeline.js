...
var ReactCalendarTimeline = function (_Component) {
  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    value: function render() {
      ...
      if ((0, _utils.getMinUnit)(this.state.visibleTimeEnd - this.state.visibleTimeStart, this.state.width, this.props.timeSteps, this.props.minCellWidth) != this.props.intendedFocus){
        this.props.onUnitChange(newMinUnit,oldMinUnit);
      }
